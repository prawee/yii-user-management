...
<div class="form">
    ...
    <?php if (Yum::module('profile')->enableProfileComments) { ?>
        ...
        <div class="row">
            ...
            echo CHtml::activeDropDownList($profile, 'allow_comments', array(
                '0' => Yum::t('No'),
                '1' => Yum::t('Yes'),
                    )
            );
    ...
    <?php if (Yum::hasModule('friendship')) { ?>
        <div class="row">
            ...
            echo CHtml::activeDropDownList($profile, 'show_friends', array(
    ...
    <?php if (Yum::module()->enableOnlineStatus) { ?>
        <div class="row">
            ...
            echo CHtml::activeDropDownList($model, 'show_online_status', array(
    ...
    <div class="row">
        ...
        echo CHtml::activeDropDownList($model, 'log_profile_visits', array(
    ...
    <?php if (Yum::hasModule('role')) { ?>
        <div class="row">
            ...
            echo CHtml::activeDropDownList($model, 'appear_in_search', array(
