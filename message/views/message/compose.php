...
<div class="form">
    ...
    if ($to_user_id) {
        ...
        echo $form->dropDownList($model, 'to_user_id', CHtml::listData(Yii::app()->user->data()->getFriends(), 'id', 'username'));
    ...
    <div class="row buttons">
        ...
        <?php
        echo CHtml::submitButton($model->isNewRecord ? Yum::t('Send') : Yum::t('Save'));
        ?>
